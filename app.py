...
selected_dataset = st.sidebar.selectbox(
    "Select dataset", options=dataset_name_map.keys()
)
...
LENGTHS = (
    len(tab_afterglow),
    len(tab_events[tab_events["event_type"] == "flare"]),
...
pg = st.navigation(
    [
        st.Page(
            "pages/burst_viewer.py", title="Burst Viewer", icon=":material/search:"
        ),
        st.Page(
            "pages/population_stats.py",
